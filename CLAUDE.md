...
pnpm --filter @chonburi/api test        # 90 unit tests (health state machine, cache dedup, adapter contracts: weather, tides, marine, datago, nasa-power, air-quality, aqicn, AIS, GISTDA, markets, facebook, chat, news, executive)
